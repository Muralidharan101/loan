<?php
    ...
    {
        header('Location: '.$path.'emp/Index');
    }
?>
<!DOCTYPE html>
...
<head>
    <title>Employee login | Mudra Finance</title>
    <meta charset="utf-8" />
        ...
        $(document).ready(function () {
            ...
            $("#signin").click(function () {
                ...
                if (username == '') {
                    ...
                    $.ajax({
                        url: '<?php echo $path;?>ajax/emp/login.php',
                        data: fd,
                        type: 'post',
                        contentType: false,
                        processData: false,
                        success: function (response) {
                            ...
                            if (data.status == 'Success') {
                                window.location.href = '<?php echo $path;?>emp/Index';
