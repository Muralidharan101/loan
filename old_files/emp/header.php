 ...
 <div class="app-container  container-fluid d-flex align-items-stretch justify-content-between " id="kt_app_header_container">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                    ...
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column">
                            <div class="fw-bold d-flex align-items-center fs-5">
                               <?php echo $_SESSION['emp_name'];?><span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Employee</span>
                            </div>
                ...
                <div class="menu-item px-5">
                    <a href="<?php echo $path.'emp/logout.php';?>" class="menu-link px-5">
                        Sign Out
                    </a>
                </div>
                <!--end::Menu item-->
