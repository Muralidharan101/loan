                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-striped table-hover" id="loan_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $count = 1;
                                                    $sql = mysqli_query($conn, "SELECT *, cld.paid_amount as cpaid, ed.id as emp_id, cd.id as cid FROM collection_data cld, client_data cd, emp_data ed,loan_data ld WHERE cld.status = 'Unpaid' AND cld.emp_id = ed.id AND cd.id = ld.client_id AND ld.emp_id = ed.id AND cld.loan_id = ld.id");
                                                ...
                                                <tr onclick='window.location.href="Client-Profile/<?php echo $loan["cid"];?>/"' style="cursor:pointer;">
                                                    ...
                                                    <td><?php echo date('d-m-Y', strtotime($loan['payment_date']));?></td>
                                                    <td><?php echo $loan['emp_name'];?></td>
                                                    <td class="text-end">₹<?php echo $loan['cpaid'];?>.00</td>
