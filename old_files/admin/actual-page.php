...
<head>
    ...
    <link href="<?php echo $path; ?>assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <script>
        (function (w, d, s, l, i) {
            ...
            j.async = true;
            j.src =
                '<?php echo $path; ?><?php echo $path; ?><?php echo $path; ?><?php echo $path; ?>www.googletagmanager.com/gtm5445.html?id=' + i + dl;
    ...
    <div id="kt_app_layout_builder" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="app-settings"
        ...
        <div class="card border-0 shadow-none rounded-0 w-100">
            ...
            <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
                ...
                style="background-image:url('<?php echo $path; ?>assets/media/misc/layout/customizer-header-bg.jpg')">
                        ...
                        <div class="card-body p-0">
                                ...
                                <div class="row " data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/preview/demos/demo1/light-ltr.png"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/preview/demos/demo1/dark-ltr.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-6">
                                    ...
                                    <a href="<?php echo $path; ?>layout-builder.html" class="fw-semibold text-primary">More layout
                                        options</a>
                                </div>
                                <!--end::Heading-->
                                ...
                                <div class="row gy-3" data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success active  active">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/misc/layout/dark-sidebar.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/misc/layout/light-sidebar.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/misc/layout/dark-header.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?php echo $path; ?>assets/media/misc/layout/light-header.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?php echo $path; ?>assets/media/avatars/300-14.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a href="<?php echo $path; ?>apps/projects/project.html"
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="<?php echo $path; ?>assets/media/avatars/300-2.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="<?php echo $path; ?>assets/media/avatars/300-20.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?php echo $path; ?>assets/media/avatars/300-1.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?php echo $path; ?>assets/media/avatars/300-23.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="<?php echo $path; ?>assets/media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/metronic8/demo1/<?php echo $path; ?>demo1/apps/projects/project.html"
                                                class="w-30px me-3" src="<?php echo $path; ?>assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="/metronic8/demo1/<?php echo $path; ?>demo1/apps/projects/project.html"
                                                class="w-30px me-3" src="<?php echo $path; ?>assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?php echo $path; ?>assets/media/stock/600x400/img-29.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?php echo $path; ?>assets/media/stock/600x400/img-31.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?php echo $path; ?>assets/media/stock/600x400/img-40.jpg" />
                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?php echo $path; ?>assets/media/avatars/300-4.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="<?php echo $path; ?>pages/user-profile/activity.html" class="btn btn-bg-body text-primary">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?php echo $path; ?>assets/media/avatars/300-25.jpg" /></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?php echo $path; ?>assets/media/avatars/300-1.jpg" /></div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="<?php echo $path; ?>apps/ecommerce/sales/details.html"
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-1.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-3.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-8.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-26.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-21.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-34.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo $path; ?>assets/media/stock/600x400/img-27.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>index.html" data-kt-href="true"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="<?php echo $path; ?>assets/media/preview/demos/placeholder.jpg"
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/marketing.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/social.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/ecommerce.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/store-analytics.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/logistics.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/delivery.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/online-courses.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/school.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/crypto.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/finance-performance.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/website-analytics.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/bidding.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/podcast.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/projects.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/call-center.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>dashboards/pos.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/projects/list/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/ecommerce/catalog/products/products.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/customers/list/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/subscriptions/list/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/user-management/users/list/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/invoices/create/main.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/support-center/overview/main.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/chat/private.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/calendar/calendar.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/file-manager/list/folders.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/inbox/listing/listing.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="<?php echo $path; ?>apps/contacts/getting-started.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="tab-pane fade show active"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/layouts/corporate/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/layouts/creative/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/layouts/fancy/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/layouts/overlay/sign-in.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/extended/multi-steps-sign-up.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/layouts/corporate/two-factor.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/password-confirmation.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/verify-email.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/welcome.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/coming-soon.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/account-deactivated.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/error-404.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/general/error-500.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="show"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/overview.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/projects.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/campaigns.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/documents.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/followers.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/user-profile/activity.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/about.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/contact.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/licenses.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/team.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/sitemap.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/social/feeds.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/social/activity.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/social/followers.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/social/settings.html"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/faq/classic.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/faq/extended.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/blog/home.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="<?php echo $path; ?>pages/blog/post.html" data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_account"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="overview.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="settings.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="billing.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="security.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="referrals.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="logs.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="api-keys.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="statements.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_modals"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/general/view-users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/general/upgrade-plan.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/top-up-wallet.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/general/share-earn.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/general/select-users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/forms/bidding.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/offer-a-deal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/forms/new-target.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/forms/new-card.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/forms/new-address.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/general/invite-friends.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/create-project.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/create-campaign.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/create-account.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/create-app.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/forms/create-api-key.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/modals/wizards/two-factor-authentication.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_wizards"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/wizards/horizontal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/wizards/vertical.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_search"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/search/users.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/search/horizontal.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/search/vertical.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>utilities/search/select-location.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_widgets"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/charts.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/feeds.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/lists.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/mixed.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/statistics.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>widgets/tables.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/welcome-message.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/subscription-confirmed.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/reset-password.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/card-declined.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/promo-1.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/promo-2.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="<?php echo $path; ?>authentication/email/promo-3.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>index.html">
                                                    Metronic Original </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/marketing.html">
                                                    Marketing Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/social.html">
                                                    Social Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/ecommerce.html">
                                                    eCommerce Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/store-analytics.html">
                                                    Store Analytics </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/logistics.html">
                                                    Logistics </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/delivery.html">
                                                    Delivery </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/online-courses.html">
                                                    Online Courses </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/school.html">
                                                    Hello Tyler </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/crypto.html">
                                                    My Balance: 37,045$ </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>dashboards/finance-performance.html">
                                                    Finance Performance </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/website-analytics.html">
                                                    Website Analytics </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/bidding.html">
                                                    Bidding Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/podcast.html">
                                                    Podcast Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/projects.html">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/call-center.html">
                                                    Call Center </a>




                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>dashboards/pos.html">
                                                    POS System </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/layouts/corporate/sign-in.html">
                                                    Corporate </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/layouts/creative/sign-in.html">
                                                    Creative </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/layouts/fancy/sign-in.html">
                                                    Fancy </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/layouts/overlay/sign-in.html">
                                                    Overlay </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/extended/multi-steps-sign-up.html">
                                                    Multi-Step </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/layouts/corporate/two-factor.html">
                                                    Two-Factor </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/password-confirmation.html">
                                                    Password Changed </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/verify-email.html">
                                                    Verify Email </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/welcome.html">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/coming-soon.html">
                                                    Coming Soon </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/account-deactivated.html">
                                                    Account Deactivated </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/error-404.html">
                                                    404 Page </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/general/error-500.html">
                                                    505 Page </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="overview.html">
                                                    Overview </a>



                                                <a class="fw-6 fw-semibold" href="settings.html">
                                                    Settings </a>



                                                <a class="fw-6 fw-semibold" href="billing.html">
                                                    Billing </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="security.html">
                                                    Security </a>



                                                <a class="fw-6 fw-semibold" href="referrals.html">
                                                    Referrals </a>



                                                <a class="fw-6 fw-semibold" href="logs.html">
                                                    Logs </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="api-keys.html">
                                                    API Keys </a>



                                                <a class="fw-6 fw-semibold" href="statements.html">
                                                    Statements </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/general/view-users.html">
                                                    View Friends </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/general/upgrade-plan.html">
                                                    Upgrade Plan </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/top-up-wallet.html">
                                                    Topup Wallet </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/general/share-earn.html">
                                                    Share & Earn </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/general/select-users.html">
                                                    Select User </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/forms/bidding.html">
                                                    Place Bid </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/offer-a-deal.html">
                                                    Offer Deal </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/forms/new-target.html">
                                                    New Target </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/forms/new-card.html">
                                                    New Card </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/forms/new-address.html">
                                                    New Address </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/general/invite-friends.html">
                                                    Invite Friend </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/create-project.html">
                                                    Create Project </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/create-campaign.html">
                                                    Create Campaign </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/create-account.html">
                                                    Create Business Account </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/create-app.html">
                                                    Create App </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/forms/create-api-key.html">
                                                    Create Api Key </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/modals/wizards/two-factor-authentication.html">
                                                    2 Factor Auth </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>utilities/wizards/horizontal.html">
                                                    2 Factor Auth </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>utilities/wizards/vertical.html">
                                                    Vertical </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>utilities/search/users.html">
                                                    Search Users </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>utilities/search/horizontal.html">
                                                    Search Horizontal </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>utilities/search/vertical.html">
                                                    Search Vertical </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>utilities/search/select-location.html">
                                                    Search Location </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/charts.html">
                                                    Charts </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/feeds.html">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/lists.html">
                                                    Lists </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/mixed.html">
                                                    Mixed </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/statistics.html">
                                                    Statistics </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>widgets/tables.html">
                                                    Tables </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/email/welcome-message.html">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/email/subscription-confirmed.html">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/email/reset-password.html">
                                                    Reset Password </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>authentication/email/card-declined.html">
                                                    Card Declined </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>authentication/email/promo-1.html">
                                                    Promotion 1 </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>authentication/email/promo-2.html">
                                                    Promotion 2 </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>authentication/email/promo-3.html">
                                                    Promotion 3 </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/overview.html">
                                                    Profile Overview </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/projects.html">
                                                    User Projects </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/campaigns.html">
                                                    User Campaigns </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/documents.html">
                                                    User Documents </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/followers.html">
                                                    User Followers </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/user-profile/activity.html">
                                                    User Activity </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/about.html">
                                                    About Us </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/contact.html">
                                                    Contact Us </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/licenses.html">
                                                    License </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/team.html">
                                                    Our Team </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/sitemap.html">
                                                    Sitemap </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/social/feeds.html">
                                                    Activity </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/social/activity.html">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/social/followers.html">
                                                    Followers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/social/settings.html">
                                                    Settings </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/faq/classic.html">
                                                    FAQ Classic </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/faq/extended.html">
                                                    FAQ Extended </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/blog/home.html">
                                                    Blog Home </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>pages/blog/post.html">
                                                    Blog Post </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/projects/list/list.html">
                                                    Projects </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>apps/ecommerce/catalog/products/products.html">
                                                    Ecommerce </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/customers/list/list.html">
                                                    Customers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/subscriptions/list/list.html">
                                                    Subscriptions </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>apps/user-management/users/list/list.html">
                                                    User Management </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/invoices/create/main.html">
                                                    Invoices </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>apps/support-center/overview/main.html">
                                                    Support Center </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/chat/private.html">
                                                    Chat </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/calendar/calendar.html">
                                                    Calendar </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>apps/file-manager/list/folders.html">
                                                    File Manager </a>



                                                <a class="fw-6 fw-semibold" href="<?php echo $path; ?>apps/inbox/listing/listing.html">
                                                    Inbox </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="<?php echo $path; ?>apps/contacts/getting-started.html">
                                                    Contacts </a>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <span class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" name="dbengine" checked
                                                        value="1" />
                                                </span>
                                                <!--end::Input-->
                                            </label>
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="<?php echo $path; ?>assets/media/svg/card-logos/visa.svg" alt=""
                                                        class="h-25px" />
                                                    <img src="<?php echo $path; ?>assets/media/svg/card-logos/mastercard.svg" alt=""
                                                        class="h-25px" />
                                                    <img src="<?php echo $path; ?>assets/media/svg/card-logos/american-express.svg"
                                                        alt="" class="h-25px" />
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="<?php echo $path; ?>assets/media/illustrations/sketchy-1/9.png" alt=""
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img src="<?php echo $path; ?>assets/media/illustrations/sketchy-1/20.png" alt=""
                                            class="mw-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-6.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-1.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-5.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-25.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-9.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-23.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-12.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-13.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?php echo $path; ?>assets/media/avatars/300-21.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="<?php echo $path; ?>assets/media/illustrations/sketchy-1/1.png" alt=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="<?php echo $path; ?>assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />
