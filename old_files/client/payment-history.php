                                                ...
                                                <div class="card-body table-responsive">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $count = 1;
                                                            $sql = mysqli_query($conn, "SELECT *, cld.status as clstat FROM loan_data ld, collection_data cld, emp_data ed WHERE ld.status = 'Active' AND ld.client_id = '$client_id' AND cld.loan_id = ld.id AND cld.emp_id = ed.id");
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php echo date('d-m-Y', strtotime($loan['payment_date']));?>
                                                                </td>
                                                                <td>
                                                                    ₹<?php echo $loan['paid_amount'];?>.00
                                                                </td>
                                                                <td>
                                                                    <?php echo $loan['emp_name'];?>
                                                                </td>
                                                                <td>
