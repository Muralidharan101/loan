                        ...
                        <!-- <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="card-body">
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Mobile Number" name="mobile" autocomplete="off" id="mobile" class="form-control form-control-solid" />
                                    <!--end::Email-->
                                </div>
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Password-->
                                    <input type="text" placeholder="Pan Number" name="password" id="password"
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#signin").click(function () {
                ...
                if (number == '') {
                    toastr.warning('Please Fill Your Mobile number!!');
                    ...
                    $.ajax({
                        url: '<?php echo $path;?>ajax/client/login.php',
                        data: fd,
                        type: 'post',
                        contentType: false,
                        processData: false,
                        success: function (response) {
                            ...
                            if (data.status == 'Success') {
                                window.location.href = '<?php echo $path;?>client/Index';
                            } else if (data.status == 'In-Active') {
                                toastr.info('may be Your Account Suspended!, Contact Admin',
                                    'Account Disabled!');
                            } else {
